...
int main(int argc, char** argv) {
    ...
    /* get time rounded to 3 decimal places*/
    double time_ms =  round((end - start)/CLOCKS_PER_SEC)/1000;

    /* print result */
    printf("Counter finish in ms %f", time_ms);
    printf("The value of counter should be %d", COUNTER_VALUE);
